...
export interface DeFiTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface DeFiToken extends BaseContract {
  connect(runner?: ContractRunner | null): DeFiToken;
  waitForDeployment(): Promise<this>;

  interface: DeFiTokenInterface;
